...
namespace Hangfire.Tags
{
    ...
    public static class GlobalConfigurationExtensions
    {
        ...
        public static IGlobalConfiguration UseTags(this IGlobalConfiguration configuration, TagsOptions options = null)
        {
            ...
            DashboardRoutes.Routes.Append(jsPath, new EmbeddedResourceDispatcher(assembly, "FaceIT.Hangfire.Tags.Resources.jquery.tagcloud.js"));
            DashboardRoutes.Routes.Append(jsPath, new EmbeddedResourceDispatcher(assembly, "FaceIT.Hangfire.Tags.Resources.script.js"));

            var cssPath = DashboardRoutes.Routes.Contains("/css[0-9]+") ? "/css[0-9]+" : "/css[0-9]{3}";
            DashboardRoutes.Routes.Append(cssPath, new EmbeddedResourceDispatcher(assembly, "FaceIT.Hangfire.Tags.Resources.style.css"));
            DashboardRoutes.Routes.Append(cssPath, new EmbeddedResourceDispatcher(assembly, "FaceIT.Hangfire.Tags.Resources.style-{0}.css", true));
